...
var consolere = require('console-remote-client').connect('console.re','80','a00218003');
...
function handleRequest(request, response){
    ...
    console.re.debug("Expected sum of 6 + 3 is 9");
    console.re.log("Sum is: "+sum+", augend is "+augend+" and addend is "+addend);
    // ASSIGNMENT
...
server.listen(server_port, server_ip_address, function(){
    ...
    console.re.log("The server is started!");
    console.re.debug("Port is: "+server_port+", ip is: "+server_ip_address);
    // ASSIGNMENT
